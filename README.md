...
[![Go Reference](https://pkg.go.dev/badge/github.com/felix-186/json.svg)](https://pkg.go.dev/github.com/felix-186/json)
[![Go Report Card](https://goreportcard.com/badge/github.com/felix-186/json)](https://goreportcard.com/report/github.com/felix-186/json)
...
```bash
go get github.com/felix-186/json
```
